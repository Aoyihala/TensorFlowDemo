...
public class TfliteRunner {
    ...
    public TfliteRunner(Context context, TfliteRunMode.Mode runmode, int inputSize, float conf_thresh, float iou_thresh) throws Exception {
    ...
    public void loadModel(Context context, TfliteRunMode.Mode runmode, int inputSize, int num_threads) throws Exception {
    ...
    static public Bitmap getResizedImage(Bitmap bitmap, int weight,int height) {
    ...
    public void setConfThresh(float thresh) {
        this.conf_thresh = thresh;
    }

    public void setIoUThresh(float thresh) {
        this.iou_thresh = thresh;
    }
    ...
    public class Recognition {
        ...
        public Recognition(
            ...
            Log.e("识别","name:"+title+"\n"+"centerLocation:x:"+location.centerX()+",y:"+location.centerY());
        }
